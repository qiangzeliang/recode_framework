...
if __name__ == '__main__':   # 测试一下自己的代码
    excle_path = "C:\\Users\\Avidly\\Desktop\\接口测试\\InterfaceTest\\unitest\\testFile\\test_user_data.xlsx"
    data_list = excel_to_list(excle_path, "TestUserLogin")  # 读取excel，TestUserLogin工作簿的所有数据

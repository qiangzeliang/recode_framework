...
class TestB(unittest.TestCase):
    ...
    def Accountkit(self):
        ...
        event=Reqspon.Recode(recode_file="dhm.har",read_file="dhm.yml",yaml_name="/v1.0/account/trace", yaml_url="https://accountkit.haloapps.com/v1.0/account/trace")
    ...
    def Package_pay(self):
        ...
        event = Reqspon.Recode(recode_file="dhm.har",read_file="dhm.yml",yaml_name="/p/ggdirect", yaml_url="https://ssl08.haloapps.com/p/ggdirect")
    ...
    def Appsflyer_t(self):
        ...
        event = Reqspon.Recode(recode_file="dhm.har",read_file="dhm.yml",yaml_name="/api/v4/androidevent", yaml_url="https://t.appsflyer.com/api/v4/androidevent")
    ...
    def Events(self):
        ...
        event = Reqspon.Recode(recode_file="dhm.har",read_file="dhm.yml",yaml_name="/api/v4/androidevent", yaml_url="https://events.appsflyer.com/api/v4/androidevent")
        """
        同样的地址抓捕的时候抓出很多会话，找出符合条件的请求
        """
        Session =[]
